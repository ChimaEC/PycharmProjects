...
class Board:
    def __init__(self, dim_size, num_bombs): 
        ...
        # initialize a set to keep track of which loactions we've uncovered
    ...
    def make_new_board(self):
        ...
        while bombs_planted < self.num_bombs:
            loc = random.randint(0, self.dim_size**2 -1) # return a random integer N sych that a <= N <= b
            row = loc // self.dim_size # we want the number of times dim_size goes into loc to tell us 
            col = loc % self.dim_size # we want the reminder to tell us what index in that row to loop
